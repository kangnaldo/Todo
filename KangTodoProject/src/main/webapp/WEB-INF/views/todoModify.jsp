					...
					<form action="modify.do" method="post">
						...
						<table class="table">
							...
							<tr>
								...
								<td><input id="subject" type="text" class="form-control"
									name="todoSubject" value="${todo.todoSubject }" /></td>
							</tr>
							<tr>
								<td><label for="content" class="control-label"><strong>내용</strong></label></td>
								<td><textarea rows="" class="form-control"
										name="todoContent">${todo.todoContent }</textarea></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input type="date" class="form-control" value="${todo.todostartdate }"
									name="startdate" required /></td>
							</tr>
							<tr>
								<td><strong>마감일</strong></td>
								<td><input type="date" class="form-control" name="enddate" value="${todo.todoenddate }"
									required /></td>
							</tr>

							<tr>
								<td colspan="2"><input type="submit" class="btn" value="수정" />
									<input type="button" class="btn" onclick="history.go(-1)"
									value="취소" /></td>
							</tr>
						</table>
					</form>
